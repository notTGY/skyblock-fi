...
export default function ItemDashboardPage() {
  ...
  const [selectedItem, _setSelectedItem] = useState<string | null>(itemId);
  ...
  useEffect(() => {
    if (bazaarData?.success && !bazaarData.products[itemId]) {
      router.push("/dashboard");
    }
  }, [bazaarData, itemId, router]);
        ...
        <main className="flex-1 p-2 overflow-auto">
          ...
          <div className="mb-2">
            <ItemSelector
              ...
              onSelectItem={(id) => router.push(`/dashboard/${id}`)}
